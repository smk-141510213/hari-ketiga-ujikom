...
<?php $__env->startSection('content'); ?>
			                	...
			                	<table border="2" class="table table-success table-border table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<div class="dropdown">
							                    <a href="#" class="dropdown-toggle btn btn-danger" data-toggle="dropdown" role="button" aria-expanded="false">Lihat Photo <span class="caret"></span>
							                    </a>
					...
					<a  href="<?php echo e(url('pegawai/create')); ?>" class="btn btn-danger form-control">Tambah</a>
