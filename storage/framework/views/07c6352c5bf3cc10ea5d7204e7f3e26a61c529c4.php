        ...
        <div class="col-md-6">
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <?php echo Form::model($tunjanganpegawai,['method'=>'PATCH','route'=>['tunjanganpegawai.update',$tunjanganpegawai->id],'enctype'=>'multipart/form-data']); ?>
                        ...
                        <div class="form-group<?php echo e($errors->has('type_user') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="type_user" type="text" class="form-control" name="type_user" value="<?php echo e($pegawai->user->type_user); ?>"  autofocus>
                ...
                <div class="panel-body">
                    <div class="form-group<?php echo e($errors->has('nip') ? ' has-error' : ''); ?>">
                        ...
                        <div class="form-group <?php echo e($errors->has('photo') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="photo" type="file" class="form-control" name="photo" value="<?php echo e($pegawai->photo); ?>"  autofocus>
